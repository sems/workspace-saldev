...
function calcscore() {
    ...
    if(score > 0 && score <= 50) {
		...
		$('#med').addClass('hide');
		$('#heavy').addClass('hide');
        $('#antwoord').text('Je hoeft je geen zorgen te maken over drugs, je hebt nergens last van.');
...
$('input').click(function() {
		...
		var String = JSON.stringify(VraagObject);
		localStorage.setItem("Vraag " + VraagObject.name, String);
	});
